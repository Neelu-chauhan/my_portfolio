    ...
    <section id="projects">
        ...
        <div class="projects-container flex s-center">
            <div class="projects-item flex f-col s-center items-center">
                ...
                <h1 class="t-white poppins">Online Quiz System</h1>
...
https://github.com/Neelu-chauhan/Chatbot"
            ...
            <div class="projects-item flex f-col s-center items-center">
                ...
                <h1 class="t-white poppins">Food Website</h1>
            ...
            <div class="projects-item flex f-col s-center items-center">
                ...
                <h1 class="t-white poppins">Cat Adoption Website</h1>
            ...
            <div class="projects-item flex f-col s-center items-center">
                <div class="image-container p-two"><br>
                    <img src=".png" alt="" border="2px solid black">
                </div>

                <h1 class="t-white poppins">Dinosaur Game</h1>
            ...
            <div class="projects-item flex f-col s-center items-center">
                <div class="image-container p-three"><br>
                    <img src="netflix.png" alt="" width="50%" border="2px solid black">
                </div>

                <h1 class="t-white poppins">Logo</h1>
            ...
            <div class="projects-item flex f-col s-center items-center">
                ...
                <h1 class="t-white poppins">Registration Form</h1>
